...
class SVGViewController {
  constructor(svgElement, containerElement, options = {}) {
    ...
    this.zoomElementFactor =
      options.zoomElementFactor || options.zoomFactor || 1.5;
  ...
  doPan(e) {
    ...
    const dx =
      (e.clientX - this.startPanPoint.x) *
      (this.currentViewBox.width / this.container.clientWidth);
    const dy =
      (e.clientY - this.startPanPoint.y) *
      (this.currentViewBox.height / this.container.clientHeight);
  ...
  adjustScrollPosition(bbox) {
    ...
    const targetScrollLeft =
      viewportX + svgRect.left - containerRect.left - containerRect.width / 2;
    const targetScrollTop =
      viewportY + svgRect.top - containerRect.top - containerRect.height / 2;
